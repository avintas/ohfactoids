...
export const factoids: FactoidData[] = [
  ...
  {
    id: "14",
    badge: { text: "SHOP", color: "purple" },
    content: "🎨 Hockey art meets daily life. Discover our collection of hockey-themed greeting cards, birthday cards, and custom designs.",
    expandedContent: "Transform your hockey passion into beautiful, meaningful moments. Our handcrafted designs celebrate the sport we love while bringing joy to every occasion. From birthday celebrations to holiday greetings, our hockey-themed collection captures the spirit, energy, and camaraderie that makes this sport special. Each design is created with attention to detail, ensuring that hockey fans can share their love for the game in style."
  },
  {
    id: "6",
    badge: { 
  ...
  },
  {
    ...
    badge: { 
      text: "TRVL", 
      color: "blue",
      image: "/images/travel-badge-001.svg"
    },
    content: "✈️ Flying with hockey gear? Delta counts your bag + 2 sticks as ONE item with no extra sports fees since 2019! Travel hack unlocked.",
  ...
  },
  {
    ...
    content: "🇰🇷 Plot twist: The fastest-growing hockey market isn't in North America - it's South Korea! From Olympics to youth leagues.",
  ...
  },
  {
    ...
    badge: { 
      text: "WEEK", 
      color: "orange",
      image: "/images/philo-badge-004.svg"
    },
    content: "🇷🇺 The Soviet hockey training system that shocked Canadian coaches in 1974 still influences youth development today. Scientific precision meets athletic artistry.",
